      ...
      <div className="flex-1 flex flex-col relative z-10 w-full ml-0 sm:ml-56">
        ...
        <main className="flex-1 w-full max-w-4xl mx-auto px-8 py-10 relative">
          <div className="mb-12 text-center animate-fadeIn">
             <h1 className="text-3xl sm:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-accent to-accent-blue inline-block mb-3">AI Historical Timeline</h1>
             <p className="text-sm text-white/40">The evolution of artificial intelligence, curated daily.</p>
          </div>

          <div className="relative pl-6 sm:pl-0 sm:mx-auto sm:max-w-2xl animate-fadeIn [animation-delay:150ms]">
            {/* The infinite vertical line */}
            <div className="absolute left-[27px] sm:left-1/2 top-4 bottom-0 w-px bg-gradient-to-b from-accent/50 via-white/10 to-transparent transform sm:-translate-x-1/2" />
